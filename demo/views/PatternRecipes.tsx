...
const RECIPES: Recipe[] = [
  ...
  },
  {
    ...
    icon: 'check-circle',
    components: ['Header', 'Card', 'ExpandableCard', 'Badge', 'ProgressBar', 'EmptyState', 'Skeleton', 'Button'],
    category: 'dashboard',
  ...
  },
  {
    ...
    icon: 'filter',
    components: ['Header', 'DateRangePicker', 'ThemePicker', 'Card', 'Field', 'Select', 'Table', 'Badge', 'StatusDot', 'ProgressBar', 'Button'],
    category: 'dashboard',
