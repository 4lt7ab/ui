...
const RECIPES: Recipe[] = [
  {
    ...
    icon: 'settings',
    components: ['PageHeader', 'Table', 'Card', 'Badge', 'StatusDot', 'ProgressBar', 'Pagination', 'Skeleton', 'ExpandableCard', 'TagChip', 'Button'],
    category: 'dashboard',
  ...
  },
  {
    ...
    icon: 'menu',
    components: ['Card', 'Badge', 'ProgressBar', 'ModalShell', 'ConfirmDialog', 'ExpandableCard', 'Table', 'EmptyState', 'Pagination', 'ThemePicker', 'IconButton'],
    category: 'crud',
  ...
  },
  {
    ...
    icon: 'edit',
    components: ['Container', 'Prose', 'Epigraph', 'PullQuote', 'MarginNote', 'SideNote', 'ThinkingCycle', 'LinkCard'],
    category: 'content',
    Component: BlogPost,
  },
  {
    ...
    icon: 'check-circle',
    components: ['PageHeader', 'Card', 'ExpandableCard', 'Badge', 'ProgressBar', 'EmptyState', 'Skeleton', 'Button'],
    category: 'dashboard',
  ...
  },
  {
    ...
    icon: 'trash',
    components: ['Card', 'Badge', 'Icon', 'IconButton', 'ConfirmDialog', 'Stack'],
    category: 'crud',
