...
`,RJ=r.forwardRef(function({children:$,id:F,"data-testid":W},K){return a.useInjectStyles(CJ,wJ),i.jsx("div",{ref:K,className:"alttab-prose",id:F,"data-testid":W,children:$})});var G=require("react"),x=l(require("react-markdown")),f=l(require("remark-gfm")),X=require("../../core/dist/index.cjs");var z=require("react/jsx-runtime");function u(J){if(typeof J==="string")return J;if(typeof J==="number")return String(J);if(Array.isArray(J))return J.map(u).join("");if(J&&typeof J==="object"&&"props"in J)return u(J.props.children);return""}function bJ(J){return J.toLowerCase().replace(/[^\w\s-]/g,"").replace(/[\s_]+/g,"-").replace(/^-+|-+$/g,"")}var t={width:14,height:14,fill:"none",stroke:"currentColor",strokeWidth:2,strokeLinecap:"round",strokeLinejoin:"round"};function e(){return z.jsxs("svg",{viewBox:"0 0 24 24",...t,children:[z.jsx("rect",{x:"9",y:"9",width:"13",height:"13",rx:"2",ry:"2"}),z.jsx("path",{d:"M5 15H4a2 2 0 01-2-2V4a2 2 0 012-2h9a2 2 0 012 2v1"})]})}function JJ(){return z.jsx("svg",{viewBox:"0 0 24 24",...t,children:z.jsx("path",{d:"M20 6L9 17l-5-5"})})}function pJ(){return z.jsxs("svg",{viewBox:"0 0 24 24",width:"18",height:"18",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[z.jsx("path",{d:"M10 13a5 5 0 007.54.54l3-3a5 5 0 00-7.07-7.07l-1.72 1.71"}),z.jsx("path",{d:"M14 11a5 5 0 00-7.54-.54l-3 3a5 5 0 007.07 7.07l1.71-1.71"})]})}var w={width:18,height:18,fill:"none",stroke:"currentColor",strokeWidth:2,strokeLinecap:"round",strokeLinejoin:"round"};function mJ(){return z.jsxs("svg",{viewBox:"0 0 24 24",...w,children:[z.jsx("circle",{cx:"12",cy:"12",r:"10"}),z.jsx("path",{d:"M12 16v-4"}),z.jsx("path",{d:"M12 8h.01"})]})}function gJ(){return z.jsx("svg",{viewBox:"0 0 24 24",...w,children:z.jsx("polygon",{points:"13 2 3 14 12 14 11 22 21 10 12 10 13 2"})})}function SJ(){return z.jsxs("svg",{viewBox:"0 0 24 24",...w,children:[z.jsx("path",{d:"M21 15a2 2 0 01-2 2H7l-4 4V5a2 2 0 012-2h14a2 2 0 012 2z"}),z.jsx("path",{d:"M12 8v3"}),z.jsx("path",{d:"M12 14h.01"})]})}function jJ(){return z.jsxs("svg",{viewBox:"0 0 24 24",...w,children:[z.jsx("path",{d:"M10.29 3.86L1.82 18a2 2 0 001.71 3h16.94a2 2 0 001.71-3L13.71 3.86a2 2 0 00-3.42 0z"}),z.jsx("path",{d:"M12 9v4"}),z.jsx("path",{d:"M12 17h.01"})]})}function xJ(){return z.jsxs("svg",{viewBox:"0 0 24 24",...w,children:[z.jsx("polygon",{points:"7.86 2 16.14 2 22 7.86 22 16.14 16.14 22 7.86 22 2 16.14 2 7.86 7.86 2"}),z.jsx("path",{d:"M15 9l-6 6"}),z.jsx("path",{d:"M9 9l6 6"})]})}var fJ="alttab-markdown-codeblock",uJ=`
  ...
  .alttab-codeblock-copy {
    ...
    width: 28px;
    height: 28px;
    border: ${X.semantic.borderWidthDefault} solid ${X.semantic.colorBorder};
    border-radius: ${X.semantic.radiusSm};
    background: ${X.semantic.colorSurface};
    color: ${X.semantic.colorTextMuted};
    cursor: pointer;
    opacity: 0;
    transition: opacity ${X.semantic.transitionBase}, color ${X.semantic.transitionBase}, border-color ${X.semantic.transitionBase};
  }
  .alttab-codeblock:hover .alttab-codeblock-copy {
    opacity: 1;
  }
  .alttab-codeblock-copy:hover {
    color: ${X.semantic.colorText};
    border-color: ${X.semantic.colorTextMuted};
  }
  .alttab-codeblock-copy[data-copied] {
    opacity: 1;
    color: ${X.semantic.colorSuccess};
    border-color: ${X.semantic.colorSuccess};
  }
`;function hJ({children:J}){X.useInjectStyles(fJ,uJ);let[$,F]=G.useState(!1),W=G.useRef(null),K=G.useCallback(()=>{let Y="",V=(Z)=>{if(typeof Z==="string"){Y+=Z;return}if(Array.isArray(Z)){Z.forEach(V);return}if(Z&&typeof Z==="object"&&"props"in Z)V(Z.props.children)};if(V(J),navigator.clipboard.writeText(Y.replace(/\n$/,"")),F(!0),W.current)clearTimeout(W.current);W.current=setTimeout(()=>F(!1),1500)},[J]);return z.jsxs("div",{className:"alttab-codeblock",children:[z.jsx("button",{type:"button",className:"alttab-codeblock-copy",onClick:K,"aria-label":"Copy code",...$?{"data-copied":""}:{},children:$?z.jsx(JJ,{}):z.jsx(e,{})}),z.jsx("pre",{children:J})]})}function v({level:J,children:$}){let F=`h${J}`,W=u($),K=bJ(W);return z.jsxs(F,{id:K,children:[$,z.jsx("a",{href:`#${K}`,className:"alttab-md-anchor","aria-label":`Link to "${W}"`,children:z.jsx(pJ,{})})]})}var cJ=/^\[!(NOTE|TIP|IMPORTANT|WARNING|CAUTION)\]\s*/,oJ={NOTE:{label:"Note",icon:mJ,attr:"note"},TIP:{label:"Tip",icon:gJ,attr:"tip"},IMPORTANT:{label:"Important",icon:SJ,attr:"important"},WARNING:{label:"Warning",icon:jJ,attr:"warning"},CAUTION:{label:"Caution",icon:xJ,attr:"caution"}};function dJ(J){let $=G.Children.toArray(J),F=$.findIndex(G.isValidElement);if(F===-1)return null;let W=$[F],K=G.Children.toArray(W.props.children),Y=K[0];if(typeof Y!=="string")return null;let V=Y.match(cJ);if(!V)return null;let Z=V[1],D=Y.slice(V[0].length);if(D||K.length>1){let A=D?[D,...K.slice(1)]:K.slice(1),B=G.cloneElement(W,{},...A);return{type:Z,content:[...$.slice(0,F),B,...$.slice(F+1)]}}return{type:Z,content:$.slice(F+1)}}function sJ({children:J}){let $=dJ(J);if($){let F=oJ[$.type],W=F.icon;return z.jsxs("div",{className:"alttab-callout","data-callout":F.attr,children:[z.jsxs("div",{className:"alttab-callout-title",children:[z.jsx(W,{}),z.jsx("span",{children:F.label})]}),z.jsx("div",{className:"alttab-callout-body",children:$.content})]})}return z.jsx("blockquote",{children:J})}var lJ="alttab-markdown-styles",rJ=`
  /* ── Base ── */
  .alttab-markdown {
    position: relative;
    font-size: ${E};
...
`;function aJ({children:J}){let $=0,F=G.Children.map(J,(W)=>{if(!G.isValidElement(W))return W;let K=$%2===1;if($++,!K)return W;let Y=G.Children.map(W.props.children,(V)=>{if(!G.isValidElement(V))return V;let Z=V.props;return G.cloneElement(V,{style:{...Z.style,background:`color-mix(in srgb, var(--color-text) ${j}, transparent)`}})});return G.cloneElement(W,{},Y)});return z.jsx("tbody",{children:F})}var iJ="alttab-markdown-editable",nJ=`
  .alttab-md-editable-display {
    cursor: pointer;
    border-radius: ${X.semantic.radiusMd};
    transition: background ${X.semantic.transitionBase};
  }

  .alttab-md-editable-display:hover {
    background: color-mix(in srgb, ${X.semantic.colorText} ${b}, transparent);
  }

  .alttab-md-editable-empty {
    cursor: pointer;
    border-radius: ${X.semantic.radiusMd};
    padding: ${X.semantic.spaceSm} ${X.semantic.spaceMd};
    font-style: italic;
    color: ${X.semantic.colorTextMuted};
    transition: background ${X.semantic.transitionBase};
  }
...
`,$J={display:"inline-flex",alignItems:"center",justifyContent:"center",gap:X.semantic.spaceSm,padding:`${X.semantic.spaceSm} ${X.semantic.spaceMd}`,fontFamily:X.semantic.fontSans,fontSize:X.semantic.fontSizeSm,fontWeight:X.semantic.fontWeightMedium,lineHeight:X.semantic.lineHeightTight,borderRadius:X.semantic.radiusMd,cursor:"pointer",transition:`background ${X.semantic.transitionBase}, border-color ${X.semantic.transitionBase}, opacity ${X.semantic.transitionBase}`},tJ={...$J,background:X.semantic.colorActionPrimary,color:X.semantic.colorTextInverse,border:"none"},eJ={...$J,background:X.semantic.colorActionSecondary,color:X.semantic.colorText,border:`${X.semantic.borderWidthDefault} solid ${X.semantic.colorBorder}`},n={pre:hJ,blockquote:sJ,tbody:aJ,h1:({children:J})=>z.jsx(v,{level:1,children:J}),h2:({children:J})=>z.jsx(v,{level:2,children:J}),h3:({children:J})=>z.jsx(v,{level:3,children:J}),h4:({children:J})=>z.jsx(v,{level:4,children:J}),h5:({children:J})=>z.jsx(v,{level:5,children:J}),h6:({children:J})=>z.jsx(v,{level:6,children:J})};function p({children:J,id:$,"data-testid":F,editable:W=!1,editing:K=!1,value:Y,onStartEdit:V,onEditChange:Z,onSave:D,onCancel:A,fieldLabel:B,rows:M=4,placeholder:T="Click to add content..."}){X.useInjectStyles(lJ,rJ),X.useInjectStyles(iJ,nJ);let[k,y]=G.useState(!1),U=G.useRef(null),H=J??"",q=G.useCallback(()=>{if(navigator.clipboard.writeText(H),y(!0),U.current)clearTimeout(U.current);U.current=setTimeout(()=>y(!1),1500)},[H]),O=G.useCallback((Q)=>{if(Q.key==="Escape")Q.preventDefault(),A?.();else if(Q.key==="Enter"&&(Q.metaKey||Q.ctrlKey))Q.preventDefault(),D?.()},[A,D]);if(W){if(K)return z.jsxs("div",{role:"group","aria-label":B,children:[z.jsx("textarea",{value:Y??"",onChange:(Q)=>Z?.(Q.target.value),onKeyDown:O,rows:M,"aria-label":B?`Edit ${B}`:"Edit content",style:{display:"block",width:"100%",boxSizing:"border-box",padding:X.semantic.spaceSm,fontFamily:X.semantic.fontMono,fontSize:"0.875rem",lineHeight:"1.6",color:X.semantic.colorText,background:X.semantic.colorSurfacePage,border:`${X.semantic.borderWidthDefault} solid ${X.semantic.colorBorder}`,borderRadius:X.semantic.radiusMd,resize:"vertical",outline:"none"}}),z.jsxs("div",{style:{display:"flex",gap:X.semantic.spaceSm,marginTop:X.semantic.spaceSm},children:[z.jsx("button",{type:"button",onClick:D,style:tJ,children:"Save"}),z.jsx("button",{type:"button",onClick:A,style:eJ,children:"Cancel"})]})]});if(!H)return z.jsx("div",{className:"alttab-md-editable-empty",role:"button",tabIndex:0,"aria-label":B?`Add ${B}`:"Add content",onClick:V,onKeyDown:(Q)=>{if(Q.key==="Enter"||Q.key===" ")Q.preventDefault(),V?.()},children:T});return z.jsx("div",{className:"alttab-md-editable-display",role:"button",tabIndex:0,"aria-label":B?`Edit ${B}`:"Edit content",onClick:V,onKeyDown:(Q)=>{if(Q.key==="Enter"||Q.key===" ")Q.preventDefault(),V?.()},children:z.jsx("div",{className:"alttab-markdown",id:$,"data-testid":F,children:z.jsx(x.default,{remarkPlugins:[f.default],components:n,children:H})})})}return z.jsxs("div",{className:"alttab-markdown",id:$,"data-testid":F,children:[z.jsx("button",{type:"button",className:"alttab-md-copy-source",onClick:q,"aria-label":"Copy markdown source",title:"Copy markdown",...k?{"data-copied":""}:{},children:k?z.jsx(JJ,{}):z.jsx(e,{})}),z.jsx(x.default,{remarkPlugins:[f.default],components:n,children:H})]})}var zJ=require("react"),FJ=require("../../core/dist/index.cjs"),L=require("react/jsx-runtime"),J1="alttab-epigraph",$1=`
  .alttab-epigraph {
    border: none;
    border-block: var(--border-width-default) solid var(--color-border);
...
`;function z1({children:J,cite:$,innerRef:F}){return L.jsxs("blockquote",{ref:F,"data-pull-quote":"",children:[L.jsx("p",{children:J}),$&&L.jsx("footer",{children:$})]})}function F1({children:J,cite:$,innerRef:F}){return FJ.useInjectStyles(J1,$1),L.jsxs("blockquote",{ref:F,className:"alttab-epigraph",children:[L.jsx("p",{children:J}),$&&L.jsx("footer",{children:$})]})}var R=zJ.forwardRef(function({children:$,variant:F="pull",cite:W},K){if(F==="epigraph")return L.jsx(F1,{innerRef:K,cite:W,children:$});return L.jsx(z1,{innerRef:K,cite:W,children:$})});var XJ=require("react");var WJ=require("react/jsx-runtime"),X1=XJ.forwardRef(function({children:$},F){return WJ.jsx(R,{ref:F,variant:"pull",children:$})});var ZJ=require("react"),KJ=require("react/jsx-runtime"),h=ZJ.forwardRef(function({children:$,side:F="left"},W){return KJ.jsx("small",{ref:W,"data-margin-note":"","data-side":F,children:$})});var VJ=require("react");var GJ=require("react/jsx-runtime"),W1=VJ.forwardRef(function({children:$},F){return GJ.jsx(h,{ref:F,side:"right",children:$})});var UJ=require("react");var YJ=require("react/jsx-runtime"),Z1=UJ.forwardRef(function({children:$,cite:F},W){return YJ.jsx(R,{ref:W,variant:"epigraph",cite:F,children:$})});var QJ=require("react/jsx-runtime");function K1({content:J,editing:$,editValue:F,onStartEdit:W,onEditChange:K,onSave:Y,onCancel:V,fieldLabel:Z,rows:D,placeholder:A}){return QJ.jsx(p,{editable:!0,editing:$,value:F,onStartEdit:W,onEditChange:K,onSave:Y,onCancel:V,fieldLabel:Z,rows:D,placeholder:A,children:J??""})}var N=require("react"),DJ=require("../../core/dist/index.cjs"),NJ=require("react/jsx-runtime"),qJ="abcdefghijklmnopqrstuvwxyz!?*~+#",V1="alttab-thinking-cycle",G1=`
  .alttab-thinking {
