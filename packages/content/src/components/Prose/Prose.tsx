...
/**
 * CSS injected once into <head>. Uses semantic CSS custom properties
 * so all styles adapt to the active theme automatically.
 *
 * Ported from 7ab.net's prose system — lead paragraphs, overline h2,
 * three-dot section breaks, blockquotes, figures, margin notes, and pull quotes.
 */
const proseCSS = /* css */ `
  /* ── Typography ── */
  .alttab-prose {
