...
function CalendarCell({
  ...
  const cellStyle = {
    ...
    ...inRange && !isEndpoint ? {
      background: `color-mix(in srgb, ${import_core26.semantic.colorActionPrimary} 15%, transparent)`
    } : {},
...
var gridCSS2 = (
  ...
  .alttab-calendar-day--enabled:hover {
    background: ${import_core27.semantic.colorSurfaceRaised} !important;
  }
  .alttab-calendar-day--enabled:focus-visible {
    outline: ${import_core27.semantic.focusRingWidth} solid ${import_core27.semantic.focusRingColor};
    outline-offset: ${import_core27.semantic.focusRingOffset};
  }
`
);
...
function CalendarGridPrimitive({
  ...
  (0, import_core27.useInjectStyles)(GRID_STYLES_ID2, gridCSS2);
  const ctx = useCalendarContext("Grid");
  const tableRef = (0, import_react24.useRef)(null);
  const todayRef = (0, import_react24.useRef)(/* @__PURE__ */ new Date());
  const year = ctx.viewDate.getFullYear();
  const month = ctx.viewDate.getMonth();
  const grid = (0, import_react24.useMemo)(() => buildCalendarGrid(year, month), [year, month]);
  ...
  const isCellDisabled = (0, import_react24.useCallback)(
    (date) => {
    ...
    "table",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("tbody", { children: rows.map((row, ri) => /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("tr", { children: row.map((date) => {
          ...
          const iso = `${date.getFullYear()}-${date.getMonth()}-${date.getDate()}`;
          return /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("td", { role: "gridcell", style: cellTdStyle, children: children ? children(renderArgs) : /* @__PURE__ */ (0, import_jsx_runtime27.jsx)(CalendarCell, { date }) }, iso);
        }) }, ri)) })
      ]
    }
  );
...
function DayCell({
  ...
  const classNames = [
    scopeClass + "-day",
    ...isDisabled2 ? [] : [scopeClass + "-day--enabled"]
  ].join(" ");
  return /* @__PURE__ */ (0, import_jsx_runtime28.jsx)("td", { role: "gridcell", style: { padding: 0 }, children: /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(
    "button",
    {
      ...
      style: cellStyle,
      tabIndex,
      "aria-selected": isEndpoint || inRange && !isDisabled2 || void 0,
      "aria-disabled": isDisabled2 || void 0,
      onClick: () => {
        if (!isDisabled2) onSelect(date);
      },
...
function CalendarGrid({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime29.jsxs)("table", { style: tableStyle2, role: "grid", "aria-label": "Calendar", children: [
    /* @__PURE__ */ (0, import_jsx_runtime29.jsx)("thead", { children: /* @__PURE__ */ (0, import_jsx_runtime29.jsx)("tr", { children: WEEKDAY_LABELS.map((label) => /* @__PURE__ */ (0, import_jsx_runtime29.jsx)("th", { scope: "col", style: weekdayHeaderStyle2, children: label }, label)) }) }),
...
function SelectFilter({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime35.jsx)("div", { style: { minWidth: "8rem", flex: "0 1 12rem" }, children: /* @__PURE__ */ (0, import_jsx_runtime35.jsxs)(Select.Root, { value, onValueChange: handleValueChange, children: [
    /* @__PURE__ */ (0, import_jsx_runtime35.jsx)(Select.Trigger, { children: /* @__PURE__ */ (0, import_jsx_runtime35.jsx)(Select.Value, { placeholder: config.placeholder }) }),
    /* @__PURE__ */ (0, import_jsx_runtime35.jsx)(Select.Content, { children: config.options.map((opt) => /* @__PURE__ */ (0, import_jsx_runtime35.jsx)(Select.Item, { value: opt.value, children: opt.label }, opt.value)) })
  ] }) });
}
