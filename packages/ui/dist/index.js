...
import { semantic as t7, useInjectStyles as useInjectStyles2 } from "../../core/dist/index.js";
...
var popoverPanelLg = {
  ...popoverPanelBaseStyle,
  borderRadius: t6.radiusLg,
  padding: t6.spaceMd,
  zIndex: t6.zIndexDropdown
};
...
var variantColors = {
  default: t8.colorTextMuted,
  primary: t8.colorActionPrimary,
  success: t8.colorSuccess,
  warning: t8.colorWarning,
  error: t8.colorError,
  info: t8.colorInfo
};
var sizeMap = {
...
var variantStyles = {
  primary: {
    background: t9.colorActionPrimary,
    color: t9.colorTextInverse,
    border: "none"
  },
  secondary: {
    background: t9.colorActionSecondary,
    color: t9.colorText,
    border: `${t9.borderWidthDefault} solid ${t9.colorBorder}`
  },
  destructive: {
    background: t9.colorActionDestructive,
    color: t9.colorTextInverse,
    border: "none"
  },
  ghost: {
    background: "transparent",
    color: t9.colorText,
    border: `${t9.borderWidthDefault} solid transparent`
  }
};
var sizeStyles = {
  sm: {
  ...
  lg: {
    padding: `${t9.spaceSm} ${t9.spaceLg}`,
    fontSize: t9.fontSizeBase,
...
var baseStyles = {
  ...
  cursor: "pointer",
  transition: `background ${t9.transitionBase}, border-color ${t9.transitionBase}, opacity ${t9.transitionBase}`
};
...
var spinnerCSS = (
  ...
  .alttab-btn-spinner {
    ...
    width: 1em;
    height: 1em;
    border: ${t9.borderWidthThick} solid currentColor;
...
var variantStyles2 = {
  default: {
    border: `${t13.borderWidthDefault} solid ${t13.colorBorder}`,
    color: t13.colorTextSecondary
  },
  primary: {
    background: `color-mix(in srgb, ${t13.colorActionPrimary} 14%, transparent)`,
    color: t13.colorActionPrimary
  },
  success: {
    background: t13.colorSuccessBg,
    color: t13.colorSuccess
  },
  warning: {
    background: t13.colorWarningBg,
    color: t13.colorWarning
  },
  error: {
    background: t13.colorErrorBg,
    color: t13.colorError
  },
  info: {
    background: t13.colorInfoBg,
    color: t13.colorInfo
  }
};
var baseStyles2 = {
  display: "inline-block",
  padding: `${t13.spaceXs} ${t13.spaceSm}`,
  borderRadius: t13.radiusFull,
  fontSize: t13.fontSizeXs,
  fontWeight: t13.fontWeightSemibold,
...
var xsBaseStyles = {
  display: "inline-block",
  fontSize: "0.6rem",
  fontFamily: t13.fontMono,
  fontWeight: t13.fontWeightMedium,
  color: t13.colorTextMuted,
  borderRadius: t13.radiusFull,
  background: `color-mix(in srgb, ${t13.colorBorder} 40%, transparent)`,
  padding: `0.0625rem ${t13.spaceXs}`,
  lineHeight: t13.lineHeightTight,
  letterSpacing: t13.letterSpacingWide,
...
var weightMap = {
  normal: t14.fontWeightNormal,
  medium: t14.fontWeightMedium,
  semibold: t14.fontWeightSemibold,
  bold: t14.fontWeightBold
};
var toneMap = {
  default: t14.colorText,
  muted: t14.colorTextMuted,
  secondary: t14.colorTextSecondary,
  inverse: t14.colorTextInverse,
  link: t14.colorTextLink,
  success: t14.colorSuccess,
  warning: t14.colorWarning,
  error: t14.colorError
};
var familyMap = {
  sans: t14.fontSans,
  serif: t14.fontSerif,
  ...
  function IconButton2({
    ...
    useInjectStyles7(
      ...
      [data-icon-btn-id="${styleId}"]:focus-visible {
        outline: ${t15.focusRingWidth} solid ${t15.focusRingColor};
        outline-offset: ${t15.focusRingOffset};
      }`
    );
      ...
      badge && /* @__PURE__ */ jsx15(
        "span",
        {
          style: {
            ...
            height: 8,
            borderRadius: t15.radiusFull,
            background: t15.colorError,
            border: `${t15.borderWidthThick} solid ${t15.colorSurface}`
          }
        }
      )
    ] });
    ...
    return /* @__PURE__ */ jsx16(
      "div",
      {
        ...
        style: {
          position: "fixed",
          inset: 0,
          background: t16.colorSurfaceOverlay,
          zIndex
        }
      }
    );
    ...
    return /* @__PURE__ */ jsxs7(
      "div",
      {
        ...
        style: {
          ...
          alignItems: "center",
          gap: t17.spaceSm,
          padding: `${t17.spaceSm} 0`
        },
        children: [
          /* @__PURE__ */ jsx17(Skeleton, { width: 32, height: 32, radius: "full" }),
          /* @__PURE__ */ jsxs7("div", { style: { flex: 1, display: "flex", flexDirection: "column", gap: t17.spaceXs }, children: [
...
var EmptyState = forwardRef18(
  function EmptyState2({
    ...
    const content = /* @__PURE__ */ jsx19("div", { style: { padding: t19.spaceXl }, children: /* @__PURE__ */ jsxs8(Stack, { align: "center", gap: "sm", children: [
      /* @__PURE__ */ jsx19("span", { style: { color: t19.colorTextMuted, display: "inline-flex" }, children: /* @__PURE__ */ jsx19(Icon, { name: icon, size: "xl" }) }),
      /* @__PURE__ */ jsx19(
        "span",
        {
          style: {
      ...
      children,
      action && /* @__PURE__ */ jsx19("div", { style: { marginTop: t19.spaceSm }, children: action })
    ] }) });
    if (variant === "card") {
...
var Header = forwardRef20(
  function Header2({ title, level = "section", subtitle, indicator, trailing }, ref) {
    ...
    const titleStyle2 = isPage ? {
      ...
      fontSize: t21.fontSizeBase,
      lineHeight: t21.lineHeightTight,
      color: t21.colorText
    };
      ...
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxs10("div", { style: { minWidth: 0 }, children: [
            /* @__PURE__ */ jsxs10("div", { style: { display: "flex", alignItems: "center", gap: t21.spaceSm }, children: [
              /* @__PURE__ */ jsx21(Tag, { style: titleStyle2, children: title }),
              indicator
            ] }),
            subtitle && /* @__PURE__ */ jsx21("span", { style: { color: t21.colorTextMuted, fontSize: t21.fontSizeSm, fontFamily: t21.fontSans }, children: subtitle })
          ] }),
          trailing && /* @__PURE__ */ jsx21("div", { style: { display: "flex", alignItems: "center", gap: t21.spaceSm, flexShrink: 0 }, children: trailing })
        ]
      }
    );
  }
          ...
          "div",
          {
            ...
            children: /* @__PURE__ */ jsx22(
              "div",
              {
                ...
                tabIndex: -1,
                style: {
                  background: t22.colorSurface,
                  color: t22.colorText,
                  borderRadius: t22.radiusLg,
                  boxShadow: t22.shadowLg,
...
var pillToggleBaseStyle = {
  display: "inline-flex",
  alignItems: "center",
  padding: `${t25.spaceXs} ${t25.spaceSm}`,
  fontSize: t25.fontSizeSm,
  fontFamily: t25.fontSans,
  fontWeight: t25.fontWeightMedium,
  lineHeight: t25.lineHeightTight,
  borderRadius: t25.radiusFull,
  cursor: "pointer",
  transition: `background ${t25.transitionFast}, border-color ${t25.transitionFast}, color ${t25.transitionFast}`,
  outline: "none"
};
var pillToggleSelectedStyle = {
  color: t25.colorActionPrimary,
  background: t25.colorActionSecondary,
  border: `${t25.borderWidthDefault} solid ${t25.colorActionPrimary}`
};
  ...
  function ConfirmDialog2({
    ...
    return /* @__PURE__ */ jsxs12(ModalShell, { ref, onClose: onCancel, role: "alertdialog", titleId, children: [
      ...
      /* @__PURE__ */ jsx23(
        ...
        {
          style: {
            margin: `${t26.spaceSm} 0 ${children ? "0" : t26.spaceLg}`,
      ...
      children && /* @__PURE__ */ jsx23("div", { style: { margin: `${t26.spaceSm} 0 ${t26.spaceLg}` }, children }),
...
[data-table-row-hoverable]:hover > td {
  background: color-mix(in srgb, ${t27.colorText} 8%, transparent);
}
[data-table-row-selected] > td {
  background: ${t27.colorSurfaceRaised};
  border-bottom-color: ${t27.colorSurfaceRaised};
}
...
[data-table-row-selected] > td:first-child::before {
  ...
  bottom: 0;
  width: 3px;
  background: ${t27.colorActionPrimary};
  pointer-events: none;
}
`;
var wrapperVariants = {
    ...
    return /* @__PURE__ */ jsx24(
      "th",
      {
        ...
        style: {
          ...
          textTransform: "uppercase",
          letterSpacing: t27.letterSpacingWide,
          borderBottom: `${t27.borderWidthThick} solid ${t27.colorBorder}`,
          whiteSpace: "nowrap",
  ...
  function TableCell2({
    ...
    return /* @__PURE__ */ jsx24(
      "td",
      {
        ...
        style: {
          padding: `${t27.spaceSm} ${t27.spaceMd}`,
          borderBottom: `${t27.borderWidthDefault} solid ${t27.colorBorder}`,
          verticalAlign: "middle",
          textAlign: align,
          color: muted ? t27.colorTextMuted : void 0,
          width: width !== void 0 ? `${width}px` : void 0,
          ...truncate ? {
            maxWidth: 0,
            overflow: "hidden",
  ...
  function TableGroupHeader2({
    ...
    return /* @__PURE__ */ jsx24("tr", { ref, style: { cursor: "default" }, children: /* @__PURE__ */ jsx24(
      "td",
      {
        colSpan,
        style: {
          padding: `${t27.spaceXs} ${t27.spaceMd}`,
          background: t27.colorSurfaceRaised,
          borderBottom: `${t27.borderWidthDefault} solid ${t27.colorBorder}`,
          fontSize: t27.fontSizeXs,
          fontWeight: t27.fontWeightBold,
          letterSpacing: t27.letterSpacingWide,
          textTransform: "uppercase",
          color: t27.colorTextMuted,
          overflow: "hidden",
  ...
  function TableEmptyRow2({
    ...
    return /* @__PURE__ */ jsx24("tr", { ref, children: /* @__PURE__ */ jsx24(
      "td",
      {
        colSpan,
        style: {
          padding: `${t27.spaceXl} ${t27.spaceMd}`,
          textAlign: "center",
          color: t27.colorTextMuted,
          fontSize: t27.fontSizeSm
        },
...
import { semantic as t32, useInjectStyles as useInjectStyles11 } from "../../core/dist/index.js";
...
import { semantic as t31, useInjectStyles as useInjectStyles10 } from "../../core/dist/index.js";
...
function CalendarCell({
  ...
  const cellStyle = {
    ...baseCellStyle,
    ...isOutsideMonth ? { color: t30.colorTextMuted, opacity: 0.5 } : {},
    ...isToday && !isEndpoint ? { border: `${t30.borderWidthDefault} solid ${t30.colorActionPrimary}` } : {},
    ...inRange && !isEndpoint ? {
      background: `color-mix(in srgb, ${t30.colorActionPrimary} 15%, transparent)`
    } : {},
    ...isEndpoint ? { background: t30.colorActionPrimary, color: t30.colorTextInverse } : {},
    ...disabled ? {
...
var placeholderStyle3 = {
  color: t33.colorTextPlaceholder
};
var headerRowStyle2 = {
  display: "flex",
  alignItems: "center",
...
var ErrorBoundary = class extends React.Component {
  ...
  render() {
    ...
    return /* @__PURE__ */ jsx33("div", { style: { borderColor: t34.colorError, borderWidth: "2px", borderStyle: "solid", borderRadius: t34.radiusLg }, children: /* @__PURE__ */ jsx33(
      Card,
      {
        variant: "flat",
        padding: "lg",
        children: /* @__PURE__ */ jsxs17("div", { style: { display: "flex", flexDirection: "column", gap: t34.spaceMd }, children: [
          /* @__PURE__ */ jsx33("div", { style: { display: "flex", alignItems: "center", gap: t34.spaceSm }, children: /* @__PURE__ */ jsx33(
            "span",
            {
              style: {
                fontSize: t34.fontSizeLg,
                color: t34.colorError,
                fontWeight: t34.fontWeightSemibold,
          ...
          /* @__PURE__ */ jsx33(
            "p",
            {
              style: {
                margin: 0,
                fontFamily: t34.fontMono,
                fontSize: t34.fontSizeSm,
                lineHeight: t34.lineHeightBase,
                color: t34.colorText,
                background: t34.colorSurfaceRaised,
                padding: t34.spaceSm,
          ...
          error.stack && /* @__PURE__ */ jsxs17("div", { children: [
            ...
            showStack && /* @__PURE__ */ jsx33(
              ...
              {
                style: {
                  marginTop: t34.spaceSm,
                  fontFamily: t34.fontMono,
                  fontSize: t34.fontSizeXs,
                  lineHeight: t34.lineHeightBase,
                  color: t34.colorTextSecondary,
                  background: t34.colorSurfaceRaised,
                  padding: t34.spaceSm,
                  borderRadius: t34.radiusMd,
                  overflow: "auto",
...
import { semantic as t35, useInjectStyles as useInjectStyles13 } from "../../core/dist/index.js";
  ...
  return /* @__PURE__ */ jsxs18(
    "div",
    {
      ...
      style: {
        ...
        paddingBottom: autoDismiss ? `calc(${t35.spaceSm} + 2px)` : t35.spaceSm,
        backgroundColor: t35.colorSurfaceSolid,
        backgroundImage: `linear-gradient(${colors.bg}, ${colors.bg})`,
        color: colors.fg,
        borderRadius: t35.radiusMd,
        borderLeft: `${t35.borderWidthAccent} solid ${colors.border}`,
...
function ToastContainer({
  ...
  const positionStyles = {
    position: "fixed",
    zIndex: t35.zIndexToast,
    display: "flex",
    flexDirection: "column",
    gap: t35.spaceSm,
    pointerEvents: "none",
    ...position.startsWith("top") ? { top: t35.spaceLg } : { bottom: t35.spaceLg },
    ...position.endsWith("right") ? { right: t35.spaceLg } : { left: t35.spaceLg }
  };
...
import { semantic as t36, useInjectStyles as useInjectStyles14 } from "../../core/dist/index.js";
...
var hoverFocusCSS = `
  .search-input-wrapper:focus-within {
    border-color: ${t38.colorBorderFocused};
    box-shadow: 0 0 0 ${t38.focusRingWidth} ${t38.focusRingColor};
  }
  @media (prefers-reduced-motion: reduce) {
